...
{   
    ...
    CHECKIN_NULL_BEER(229, "IdBeer non valorizzato"),
    CHECKIN_MISSING_BEER(230, "Birra non esistente"),
    CHECKIN_NULL_PLACE(231, "idPlace non valorizzato"),
    CHECKIN_MISSING_PLACE(232, "Locale non esistente"),
